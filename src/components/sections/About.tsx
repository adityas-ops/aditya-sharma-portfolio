      ...
      <div className="flex justify-start items-center gap-[20px]">
        <div className="flex items-end">
          <p
            ...
            className="relative before:content-['01.'] before:font-SFMono-Regular before:text-[1.25rem] sm:before:text-[1.5rem] before:text-active-color before:mr-[10px] leading-none text-[1.75rem] sm:text-[2rem] font-Calibre-Semibold text-[#ccd6f6] a font-[600]"
          >
            About Me
          </p>
        </div>
      ...
      <div className="w-full flex flex-col sm:flex-row justify-center sm:justify-start gap-[50px] items-center mt-[50px]">
        ...
        <div className=" w-full sm:w-fit flex justify-center sm:max-w-[50%] group">
          ...
          >
            ...
            <div className="absolute inset-0 picture-overlay bg-[#64ffda]/80 contrast-100   mix-blend-multiply -translate-y-4 -translate-x-4 rounded-md transition-opacity duration-300 group-hover:opacity-0"></div>
          </div>
        </div>
      </div>
    </div>
