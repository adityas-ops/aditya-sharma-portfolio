...
const Contact = () => {
  ...
  return (
    ...
    >
      <h2 ref={headlineRef} className="block mb-5 text-[#64ffda] font-SFMono-Regular text-[16px] font-normal before:content-['04.'] before:mr-2 before:text-[#64ffda] before:text-[14px]">
        What's Next?
      </h2>

      <h2 ref={titleRef} className="text-[clamp(40px,5vw,60px)] font-bold text-white mb-4">
        Get In Touch
      </h2>
      ...
      <div ref={contentRef}>
        ...
        <a 
          className="inline-block py-4 px-8 text-[14px] font-SFMono-Regular text-[#64ffda] border border-[#64ffda] rounded-[4px] bg-transparent transition-all duration-300 hover:bg-[#64ffda] hover:text-[#091930] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[4px_4px_0_0_#64ffda]"
          href={`mailto:${email}`}
        >
          Say Hello
        </a>
